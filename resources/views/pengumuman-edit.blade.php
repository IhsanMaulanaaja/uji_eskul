            ...
            <div class="card">
                ...
                <form action="{{ route('pengumuman.update', $pengumuman->id) }}" method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <select name="ekskul_id" id="ekskul_id" required>
                            ...
                            @foreach($ekskuls as $ekskul)
                                <option value="{{ $ekskul->id }}" {{ $pengumuman->ekskul_id == $ekskul->id ? 'selected' : '' }}>
                                    {{ $ekskul->nama }}
                                </option>
                            @endforeach
                        </select>
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="isi" id="isi" placeholder="Jelaskan detail pengumuman..." required>{{ $pengumuman->isi }}</textarea>
