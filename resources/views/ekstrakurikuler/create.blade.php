...
<head>
    ...
    <title>Tambah Ekstrakurikuler - SmartSchool Ekskul</title>
            ...
            <div class="card">
                <form method="POST" action="{{ route('ekstrakurikuler.store') }}" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" id="nama" name="nama" value="{{ old('nama') }}" required placeholder="Masukkan nama ekskul">
                        @error('nama')
                    ...
                    <div class="form-group">
                        ...
                        <textarea id="deskripsi" name="deskripsi" placeholder="Masukkan deskripsi ekskul (opsional)">{{ old('deskripsi') }}</textarea>
                        @error('deskripsi')
                            <span class="error">{{ $message }}</span>
                        @enderror
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="file-input-wrapper">
                            ...
                            <label for="foto" class="file-input-label">
                                <i class="fas fa-cloud-upload-alt"></i> Klik untuk memilih foto atau drag & drop
                            </label>
                        </div>
